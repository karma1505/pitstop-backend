...
public class FinancialTransactionResponse {
    ...
    public FinancialTransactionResponse() {}
        ...
        public FinancialTransactionResponse(UUID id, BigDecimal amount, Enums.TransactionType transactionType, 
                                       LocalDateTime transactionDate, LocalDate transactionDateOnly, String description, String status,
                                       CustomerSummary customer, VehicleSummary vehicle, JobCardSummary jobCard,
                                       Enums.PaymentMethod paymentMethod, Enums.ExpenseCategory expenseCategory, String vendorName,
