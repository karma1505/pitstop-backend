 ...
 *   When they provide customer details
 *   Then the system should create a customer record
 *   And return the customer information
 */
public class CreateCustomerRequest {
    ...
    public CreateCustomerRequest(String name, String phone, String email, String addressLine1, 
